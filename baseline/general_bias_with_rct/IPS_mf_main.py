...
from baseline_models import PureMatrixFactorization
from baseline_train import IPSBasicTrainManager, naive_bayes_propensity
...
def main(
    ...
    model: PureMatrixFactorization = PureMatrixFactorization(
    ...
    train_manager: IPSBasicTrainManager = IPSBasicTrainManager(
