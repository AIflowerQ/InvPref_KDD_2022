...
from baseline_train import IPSBasicTrainManager, basic_pair_propensity_func, basic_item_propensity_func
...
def main(
    ...
    train_manager: IPSBasicTrainManager = IPSBasicTrainManager(
        ...
        device=device, propensity_func=basic_item_propensity_func,
