...
from baseline_train import SNIPSMFTrainManager, basic_pair_propensity_func, basic_item_propensity_func
...
def main(
    ...
    train_manager: SNIPSMFTrainManager = SNIPSMFTrainManager(
        ...
        device=device, propensity_func=basic_pair_propensity_func,
