...
from baseline_train import FairnessMFTrainManager
...
def main(
    ...
    train_manager: FairnessMFTrainManager = FairnessMFTrainManager(
        ...
        test_begin_epoch=train_config['test_begin_epoch'], fairness_coe=train_config['fairness_coe'],
        weight_smooth_coe=train_config['weight_smooth_coe'], item_batch_size=train_config['item_batch_size']
    )
