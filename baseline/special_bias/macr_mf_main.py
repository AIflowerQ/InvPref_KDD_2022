...
from baseline_models import MACRMatrixFactorization
from train import BasicImplicitTrainManager
...
RANDOM_SEED_LIST = [17373331, 17373522, 17373507]
...
def main(
    ...
    model: MACRMatrixFactorization = MACRMatrixFactorization(
        user_num=data_loader.user_num,
        item_num=data_loader.item_num,
        factor_num=model_config['factor_num'],
        const_c=model_config['const_c'],
        item_coe=model_config['item_coe'],
        user_coe=model_config['user_coe']
    )
    ...
    train_manager: BasicImplicitTrainManager = BasicImplicitTrainManager(
