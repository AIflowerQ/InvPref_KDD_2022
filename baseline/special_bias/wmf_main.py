...
from baseline_train import WMFTrainManager
...
def main(
    ...
    train_manager: WMFTrainManager = WMFTrainManager(
        ...
        test_begin_epoch=train_config['test_begin_epoch'], imputation_coe=train_config['imputation_coe'],
        user_batch_size=train_config['user_batch_size'], item_batch_size=train_config['item_batch_size']
    )
