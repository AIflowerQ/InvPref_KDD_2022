...
from baseline_models import CausEExplicitMatrixFactorization
from baseline_train import CausEExplicitTrainManager
...
def main(
    ...
    model: CausEExplicitMatrixFactorization = CausEExplicitMatrixFactorization(
    ...
    train_manager: CausEExplicitTrainManager = CausEExplicitTrainManager(
