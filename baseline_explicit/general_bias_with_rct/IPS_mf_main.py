...
from dataloader import ExplicitUniformDataLoader
from evaluate import ExplicitTestManager
from baseline_models import PureExplicitMatrixFactorization
from baseline_train import IPSBasicExplicitTrainManager, naive_bayes_propensity
...
# RANDOM_SEED_LIST = [17373331, 17373522, 17373507, 17373511, 17373423, 2021310803, 123456, 666]
# RANDOM_SEED_LIST = [17373507, 17373511, 17373423, 2021310803, 123456, 666]
# RANDOM_SEED_LIST = [17373331]
# RANDOM_SEED_LIST = [999]

DATASET_PATH = '/Yahoo_explicit_uniform_data/'
...
def main(
        ...
        train_config: dict,
        evaluate_config: dict,
        data_loader: ExplicitUniformDataLoader,
        random_seed: int,
        silent: bool = False,
        auto: bool = False,
        query: bool = True,
    ...
    train_manager: IPSBasicExplicitTrainManager = IPSBasicExplicitTrainManager(
        model=model, propensity_func=naive_bayes_propensity,
        evaluator=evaluator, training_data=train_tensor,
        device=device,
        ...
        test_begin_epoch=train_config['test_begin_epoch'], smooth_weight_coe=train_config['smooth_weight_coe'],
        uniform_data=uniform_tensor
    )
...
if __name__ == '__main__':
    loader: ExplicitUniformDataLoader = ExplicitUniformDataLoader(
