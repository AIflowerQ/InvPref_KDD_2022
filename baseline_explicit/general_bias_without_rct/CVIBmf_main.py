...
from baseline_train import CVIBExplicitTrainManager
...
def main(
    ...
    train_manager: CVIBExplicitTrainManager = CVIBExplicitTrainManager(
        ...
        test_begin_epoch=train_config['test_begin_epoch'], alpha=train_config['alpha'],
        gamma=train_config['gamma'], info_coe=train_config['info_coe']
    )
