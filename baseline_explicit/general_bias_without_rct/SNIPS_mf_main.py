...
from baseline_train import SNIPSExplicitMFTrainManager, basic_item_propensity_func
...
DATASET_PATH = '/Coat_explicit_all_data/'
...
def main(
    ...
    train_manager: SNIPSExplicitMFTrainManager = SNIPSExplicitMFTrainManager(
        model=model, propensity_func=basic_item_propensity_func,
